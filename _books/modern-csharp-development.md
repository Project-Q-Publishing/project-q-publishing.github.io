...
currency: "USD"
pages: 598
cover_image: "/assets/images/books/modern-csharp-development.jpg"
description: >-
  Master modern C# development with .NET 8, covering async programming, LINQ,
  dependency injection, cloud-native architectures, and best practices for building
  scalable enterprise applications. Includes ASP.NET Core, Entity Framework, and Azure integration.
...
topics:
  ...
  - "DevOps"
target_audience: "C# Developers, .NET Engineers, Full-Stack Developers, Enterprise Architects"
purchase_links:
  amazon: "https://amazon.com/dp/example7"
  publisher: "/contact"
sample_chapters:
  - "Chapter 3: Advanced Async/Await Patterns"
  - "Chapter 8: Building RESTful APIs with ASP.NET Core"
reviews:
  - quote: "The most comprehensive guide to modern C# I've encountered"
    author: ".NET Weekly"
    rating: 5
  - quote: "Essential reading for professional .NET developers"
    author: "Microsoft MVP Review"
    rating: 5
featured: false
---
...
5. Async/Await Deep Dive
6. Task Parallel Library and Parallel Programming
7. Channels and Advanced Concurrency Patterns
8. Performance Considerations in Async Code

### Part III: ASP.NET Core Development
9. Building RESTful APIs with ASP.NET Core
10. Minimal APIs and Modern Web Development
11. Authentication and Authorization
12. Middleware, Filters, and Request Pipeline
13. SignalR for Real-Time Communication

### Part IV: Data Access and Persistence
14. Entity Framework Core Fundamentals
15. Advanced EF Core: Performance and Optimization
16. Repository and Unit of Work Patterns
17. Dapper and Alternative ORMs

### Part V: Testing and Quality
18. Unit Testing with xUnit and NUnit
19. Integration Testing Strategies
20. Test-Driven Development in Practice
21. Behavior-Driven Development with SpecFlow

### Part VI: Cloud-Native Development
22. Microservices Architecture with C#
23. Docker and Container Orchestration
24. Azure Service Integration
25. Serverless with Azure Functions

### Part VII: Advanced Topics
26. Memory Management and Performance Profiling
27. Logging, Monitoring, and Observability
28. gRPC and Modern RPC Patterns
29. GraphQL APIs with HotChocolate
30. Deployment Strategies and CI/CD
